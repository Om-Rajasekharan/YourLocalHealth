    ...
    <aside className="dashboard-sidebar sticky top-5 hidden max-h-[calc(100vh-2.5rem)] overflow-y-auto lg:block">
      <div className="quiet-surface field-report p-4">
        <div className="relative z-10 border-b border-[var(--rule)] pb-4">
          ...
          <h2 className="mt-2 text-xl font-bold leading-tight text-[var(--foreground)]">
            {city}, {state}
          </h2>
          <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-[var(--foreground-faint)]">
            ZIP {zipCode}
          </p>
          <p className="mt-3 text-sm leading-5 text-[var(--foreground-muted)]">
            {activeDashboardView.description}
          </p>
        </div>
        ...
        <div className="absolute bottom-3 left-3 right-3 flex flex-col gap-3 sm:bottom-4 sm:left-4 sm:right-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            ...
            <button
              ...
              disabled={loading}
              className="w-full rounded-full border border-[var(--accent)]/40 bg-[var(--accent)] px-4 py-2 text-sm font-bold text-[var(--background)] transition hover:bg-[var(--accent-ink)] disabled:cursor-wait disabled:opacity-70 sm:w-auto"
            >
      ...
      >
        <defs>
          <linearGradient id="street-ground" x1="0" x2="1" y1="0" y2="1">
            <stop offset="0%" stopColor="#F3E6D6" />
            <stop offset="100%" stopColor="#B9C2A6" />
          </linearGradient>
              ...
              <div className="landing-hero-copy">
                ...
                >
                  ...
                  <input
                    ...
                    value={zipCode}
                    onChange={(event) => setZipCode(event.target.value)}
                    className="h-14 min-w-0 flex-1 rounded-full border border-transparent bg-white px-5 text-base font-semibold text-[var(--foreground)] shadow-sm outline-none transition placeholder:text-slate-500 focus:ring-4 focus:ring-[var(--accent-soft)]"
                  />

                  <button
                    type="submit"
                    disabled={loading}
                    className="h-14 rounded-full bg-[var(--foreground)] px-7 text-sm font-bold text-[var(--background)] shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:bg-[var(--accent-ink)] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-600"
                  >
            ...
            <div className="min-w-0">
              <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="flex flex-col gap-2 sm:items-end">
                  <span className="w-fit border-l-[3px] border-[var(--accent)] bg-[var(--accent-soft)] py-1 pl-2 pr-3 font-mono text-xs font-semibold text-[var(--accent-ink)]">
